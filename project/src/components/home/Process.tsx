              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3
                      className={`text-xl md:text-2xl font-bold mb-3 transition-colors duration-300 ${isActive ? 'text-[#a8042b]' : 'text-[#223258] group-hover:text-blue-800'
                        }`}
                    >
                      {item.title}
                    </h3>
                ...
                {idx < steps.length - 1 && (
                  <div className="hidden md:flex absolute top-[6.5rem] -right-5 transform -translate-y-1/2 z-20 items-center justify-center">
                    ...
                    >
                      <ArrowRight
                        className={`transition-colors duration-500 ${isPassed ? 'text-white' : 'text-slate-400'
                          }`}
                        size={18}
                      />
                    </div>
