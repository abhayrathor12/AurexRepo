...
import webinarpdf from "../../public/posters/Brochure.pdf";
interface Event {
  id: string;
  title: string;
  slug: string;
...
export function EventsListsSection({
  ...
  const isWebinar = selectedEvent?.slug === 'Deal-Smart-2026';
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <div className="flex items-start justify-between gap-4 mb-4">
                        ...
                        {isWebinar && (
                          <div className="flex-shrink-0 flex flex-col items-end gap-1.5 py-2 px-3 rounded-xl text-right"
                            ...
                            <p className="text-lg font-black leading-none" style={{ color: CRIMSON }}>₹499</p>
                            <span
