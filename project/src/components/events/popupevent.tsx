...
import leftimage from "../../public/leftiamge.jpeg";
// ─── Types ─────────────────────────────────────────────────────────────────────
type FormData = {
    name: string;
    email: string;
...
export default function StartupRegistrationPage() {
    ...
    return (
        <div className="flex min-h-screen" style={{ background: "#ffffff", fontFamily: "'system-ui', sans-serif" }}>
            ...
            <div className="hidden lg:block w-1/2 flex-shrink-0 sticky top-0 h-screen overflow-y-auto hide-scrollbar" >
                <div className="poster-panel w-full h-full overflow-y-auto">
                    <img src={leftimage} alt="..." className="w-full h-auto block" />
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 relative lg:h-screen lg:flex lg:flex-col lg:overflow-hidden">
                ...
                <div className="lg:hidden w-full">
                    <img src={leftimage} alt="Udbhav 2026" className="w-full h-auto block" />
                </div>
