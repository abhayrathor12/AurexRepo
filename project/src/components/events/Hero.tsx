...
export function EventsHero() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center px-4 py-6 overflow-hidden">
      {/* Dynamic Background */}
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-10 right-20 w-72 h-72 rounded-full blur-3xl transition-all duration-1000"
          style={{
        ...
        />
        <div
          className="absolute bottom-10 left-20 w-64 h-64 rounded-full blur-3xl transition-all duration-1000"
          style={{
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-5">
            <div className="space-y-4">
              ...
              <p className="text-base md:text-lg text-[#223258]/70 leading-relaxed max-w-xl">
            ...
            <div className="grid sm:grid-cols-3 gap-4 pt-2 max-w-xl">
              <div className="p-3 rounded-xl bg-white/70 border border-[#223258]/10 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
                <h4 className="font-semibold text-[#a8042b] mb-1 text-sm">Curated Events</h4>
              ...
              <div className="p-3 rounded-xl bg-white/70 border border-[#223258]/10 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
                <h4 className="font-semibold text-[#a8042b] mb-1 text-sm">Expert-Led</h4>
                <p className="text-xs text-[#223258]/70">
              ...
              <div className="p-3 rounded-xl bg-white/70 border border-[#223258]/10 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
                <h4 className="font-semibold text-[#a8042b] mb-1 text-sm">Founder-Focused</h4>
                <p className="text-xs text-[#223258]/70">
              ...
              <div className="relative w-56 h-72">
                {events.map((event, index) => {
                  ...
                  if (isActive) {
                    ...
                    transform = 'translateX(-50px) translateY(15px) scale(0.8) rotateY(25deg)';
                    opacity = 0.4;
                    zIndex = 2;
                  } else if (isNext) {
                    transform = 'translateX(50px) translateY(15px) scale(0.8) rotateY(-25deg)';
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-full h-full rounded-2xl bg-gradient-to-br ${event.color} p-6 shadow-2xl backdrop-blur-sm flex flex-col items-center justify-center text-white relative overflow-hidden`}
                        style={{
                      ...
                      >
                        <div
                          ...
                          style={{ transform: `translateX(${time % 100}%)` }}
                        />
                        ...
                        <h3 className="text-xl font-bold text-center mb-1">{event.title}</h3>
                        <p className="text-xs opacity-90 text-center">{event.desc}</p>
                      </div>
                    </div>
                  );
                })}
                ...
                {[...Array(8)].map((_, i) => {
                  ...
                  return (
                    <line
                      ...
                      strokeWidth="1.5"
                      strokeDasharray="4 4"
                      style={{ animation: `dashMove 2s linear infinite`, animationDelay: `${i * 0.2}s` }}
                    />
                  );
                })}
              </svg>
